...
void loadTasksFromFile(std::vector<Task>& tasks, int& nextId);
void addTask(std::vector<Task>& tasks, int& nextId, bool save);
void viewTasks(const std::vector<Task>& tasks);
void markTaskComplete(std::vector<Task>& tasks, bool save);
void removeTask(std::vector<Task>& tasks, bool save);
